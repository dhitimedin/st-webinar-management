...
//$start_date = strtotime( get_post_meta( get_the_ID(), 'startDate', true ) );
$start_date = get_post_meta( get_the_ID(), 'startDate', true );
$start_date = $start_date ? explode( ' ', $start_date ) : null;
		...
		<header class="entry-header alignwide">
			...
			<div class="st-webinar-singlepage-title">
				<div class="st-start-date-container">
					<?php $a = get_post_meta( get_the_ID() ); ?>
					<?php //$start_date = strtotime( get_post_meta( get_the_ID(), 'startDate', true ) ); ?>
					<span class="st-day">
						<?php echo esc_attr( gmdate( 'd', strtotime( $start_date[0] ) ) ); ?>
					</span>
					<span class="st-month">
						<?php echo esc_attr( gmdate( 'M', strtotime( $start_date[0] ) ) ); ?>
					</span>
				</div>
